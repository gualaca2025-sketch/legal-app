...
<body>
  <div class="header">
    <h1>José María Araúz Barraza</h1>
    <p>David, Chiriquí • República de Panamá</p>
    <p>Móvil: 6615-6227 • Email: jmarauz@hotmail.es</p>
    <span class="badge">${title}</span>
  </div>
  <div class="title">${title}</div>
  ${content}
  <div class="footer">
    <p><strong>José María Araúz Barraza</strong> - Su confianza, nuestro compromiso</p>
