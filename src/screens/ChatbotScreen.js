...
const initialMessages = [
  { id: '0', text: '🤖 ¡Hola! Soy el asistente virtual de *José María Araúz Barraza*. ¿En qué puedo ayudarle hoy?', sender: 'bot', timestamp: new Date() },
  { id: '1', text: 'Puede preguntarme sobre:\n📅 Citas\n⚖️ Casos\n💰 Costos\n📋 Horarios\n📍 Ubicación', sender: 'bot', timestamp: new Date() },
];

const quickReplies = [
  'Horarios', 'Dirección', 'Agendar cita',
  'Costos de honorarios', 'Emergencia legal', 'Tipo de caso',
];
